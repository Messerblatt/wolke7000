...
Jede Halle erhielt eine eigene Farbe und einen eigenen Geruchscode. Biodiesel wurde grün markiert, Methanol blau, synthetischer Kraftstoff weiß und alles, dessen Herkunft unklar war, mit einem schwarzen Kreis.
...
## Lore-Snippet: Die erste schwimmende Operation
...
Die Besatzung der Bertha fasste sie nüchterner zusammen:

> „Die haben unser Schiff auseinandergebaut, während wir noch drin gekocht haben.“

---

## Lore-Snippet: Die offene Werkbank

Das Diskoord folgt dem Prinzip der **offenen Werkbank**. Reparaturpläne, Umbauten und neue Konstruktionen werden grundsätzlich öffentlich dokumentiert. Wer eine Verbesserung entwickelt, darf sie benennen, aber nicht exklusiv kontrollieren.

An jedem fertiggestellten Bauteil befindet sich eine kleine Plakette mit der Entwicklungsgeschichte:
...
Der letzte Eintrag bezeichnet keine technische Änderung. Er ist dennoch auf fast allen Bauteilen vorhanden.

Diese Praxis führte dazu, dass viele Boote NeuBerlins aus Generationen kleiner Modifikationen bestehen. Manche Schiffe besitzen keine eindeutig bestimmbare Ursprungskonstruktion mehr. Sie gelten als **gewachsene Fahrzeuge**.

---

## Lore-Snippet: Der Funkturm
...
Von dort aus werden Flugrouten aktualisiert, Störungen gemeldet und Transportanfragen an die passenden Bootsverbände weitergegeben. Dadurch sind Funkturm und Werft eng miteinander verbunden: Open Wing teilt mit, **was gebraucht wird**, während das Diskoord dafür sorgt, dass ein funktionsfähiges Schiff es transportieren kann.

---

## Lore-Snippet: Der erste offene Reparaturtag
...
> **„Keine Vorkenntnisse nötig. Selbstüberschätzung vorhanden.“**

Der Tag dient nicht nur der Reparatur, sondern auch der Ausbildung. Viele spätere Techniker lernten dort zum ersten Mal, wie Pumpen, Propeller, Elektromotoren und Rumpfverbände funktionieren.
...
Beschleunigung: unanständig
Sitz: optional
Wasserlage: Kann mich nicht erinnern
```
...
> „Selbstverständlich. Alles andere wär ja peinlich.“

Der ehemalige Kanonier wechselte anschließend freiwillig in die Küche.

---

### Lore-Snippet: Das schönste hässliche Schiff

Innerhalb des Diskoords ist funky für ein jährliches Ritual bekannt. Beim Offenen Reparaturtag wählt sie das **schönste hässliche Schiff** aus: ein Boot, das technisch improvisiert, ästhetisch fragwürdig und dennoch bemerkenswert funktional ist.

Die Auszeichnung besteht aus einer kleinen metallenen Haiflosse, die an den Rumpf geschraubt wird. Sie gilt unter NeuBerliner Bootsbauern als größere Ehre als manche offizielle Werftplakette.

funkys Laudatio fällt gewöhnlich knapp aus:
